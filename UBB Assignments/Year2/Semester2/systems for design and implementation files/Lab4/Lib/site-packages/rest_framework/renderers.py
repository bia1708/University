...
REST framework also provides an HTML renderer that renders the browsable MovieList.
"""
import base64
...
class BrowsableAPIRenderer(BaseRenderer):
    """
    HTML renderer used to self-document the MovieList.
    """
    media_type = 'text/html'
    format = 'api'
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        """
        Render the HTML for the browsable MovieList representation.
        """
