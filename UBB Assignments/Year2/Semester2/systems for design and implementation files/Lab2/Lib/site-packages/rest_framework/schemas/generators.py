...
class EndpointEnumerator:
    """
    A class to determine the available MovieList endpoints that a project exposes.
    """
    ...
    def get_api_endpoints(self, patterns=None, prefix=''):
        """
        Return a list of all available MovieList endpoints by inspecting the URL conf.
        """
        if patterns is None:
