...
def load_system(source_dir):
    """
    Load the build system from a source entry (pyproject.toml).
    """
...
def compat_system(source_dir):
    """
    Given a source entry, attempt to get a build system backend
...
parser.add_argument(
    '--out-entry', '-o',
    help="Destination in which to save the builds relative to source entry",
)
