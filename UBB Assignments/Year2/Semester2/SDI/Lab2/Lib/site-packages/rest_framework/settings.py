...
def import_from_string(val, setting_name):
    ...
    try:
        ...
        msg = "Could not import '%s' for MovieList setting '%s'. %s: %s." % (val, setting_name, e.__class__.__name__, e)
...
class APISettings:
    ...
    def __getattr__(self, attr):
        if attr not in self.defaults:
            raise AttributeError("Invalid MovieList setting: '%s'" % attr)
