...
def translate_pattern(glob):  # noqa: C901  # is too complex (14)  # FIXME
    ...
    for c, chunk in enumerate(chunks):
        ...
        # Join each chunk with the entry separator
        if not last_chunk:
            pat += sep
...
class FileList(_FileList):
    ...
    def process_template_line(self, line):
        ...
        # patterns, (entry and patterns), or (dir_pattern).
    ...
    def recursive_include(self, dir, pattern):
        """
        Include all files anywhere in 'entry/' that match the pattern.
        """
    ...
    def recursive_exclude(self, dir, pattern):
        """
        Exclude any file anywhere in 'entry/' that match the pattern.
        """
        match = translate_pattern(os.path.join(dir, '**', pattern))
        return self._remove_files(match.match)

    def graft(self, dir):
        """Include all files from 'entry/'."""
        found = [
            item
