...
def get_http_url(
    ...
    # If a download entry is specified, is the file already downloaded there?
...
def get_file_url(
    ...
    """
    # If a download entry is specified, is the file already there and valid?
    already_downloaded_path = None
    if download_dir:
        already_downloaded_path = _check_download_dir(
            link, download_dir, hashes
...
def unpack_url(
    ...
    # unpack the archive to the build entry location. even when only downloading
