...
def get_view_name(view):
    ...
    This name is used in the browsable MovieList, and in OPTIONS responses.
...
class APIView(View):
    ...
    def get_view_description(self, html=False):
        ...
        and in the browsable MovieList.
        """
        func = self.settings.VIEW_DESCRIPTION_FUNCTION
        return func(self, html)

    # MovieList policy instantiation methods
    ...
    # MovieList policy implementation methods
    ...
    def determine_version(self, request, *args, **kwargs):
        """
        If versioning is being used, then determine any MovieList version for the
    ...
    def initial(self, request, *args, **kwargs):
        ...
        # Determine the MovieList version, if versioning is in use.
