...
determining the URL conf for your MovieList.
...
class DefaultRouter(SimpleRouter):
    ...
    MovieList root view, and adds format suffix patterns to the URLs.
    """
    ...
    def get_urls(self):
        ...
        for the MovieList, and appending `.json` style format suffixes.
        """
        urls = super().get_urls()
