...
public class PrgState {
    ...
    // CONSTRUCTOR
    public PrgState(IMyStack<IStatement> exeStack, IMyDictionary<String, Value> symTable, IMyHeap<Value> heap, IMyList<Value> out, IMyDictionary<StringValue, BufferedReader> fileTable, IStatement prg) {
