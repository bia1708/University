...
public class NewTableController {
    ...
    @FXML
    private TableView<Pair<String, Value>> semTable;
    @FXML
    private TableColumn<Pair<String, Value>, String> semTableIndexColumn;
    @FXML
    private TableColumn<Pair<String, Value>, String> semTableValueNameColumn;
    @FXML
    private TableColumn<Pair<String, Value>, List<String>> semTableListColumn;


    public NewTableController(Controller controller) {
    ...
    void initialize() {
        ...
        semTableIndexColumn.setCellValueFactory(pair -> new SimpleStringProperty(pair.getValue().getKey().toString()));
        semTableIndexColumn.setCellValueFactory(pair -> new SimpleStringProperty(pair.getValue().getValue().toString()));
//        semTableListColumn.setCellValueFactory(pair -> new SimpleStringProperty(semTableListColumn.toString()));
