...
Update: Added text-file repo and binary-file repo
"""

import pickle
from src.misc.data_structure import DataStructure
...
class Repository(object):
    def __init__(self, data=None):
        if data is None:
            self._data = {}
        elif data is DataStructure:
            self._data = data
        else:
            self._data = DataStructure(data)
